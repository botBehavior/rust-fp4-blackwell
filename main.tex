...
@misc{vectorware, title={Rust's Standard Library on the {GPU}}, author={{VectorWare}}, year={2026}, howpublished={\url{https://www.vectorware.com/blog/rust-std-on-gpu/}}}
@misc{kostrubiec2026, title={Why {Rust's} Semantics Don't Fit {GPUs} (Yet)}, author={Kostrubiec, Micha\l{}}, year={2026}, howpublished={RustWeek 2026 talk. \url{https://www.youtube.com/watch?v=XnU9eBNTHG0}}}
@misc{cubecl, title={{CubeCL}: Multi-platform High-performance Compute Language Extension for {Rust}}, author={{Tracel AI}}, howpublished={\url{https://github.com/tracel-ai/cubecl}}}
